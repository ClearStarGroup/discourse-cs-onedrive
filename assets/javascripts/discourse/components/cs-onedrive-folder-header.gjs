    ...
    <div class="topic-meta-data">
      <div class="names">
        <span class="first username cs-onedrive-header">
          {{i18n "discourse_cs_onedrive.section_header"}}
        </span>
      </div>
        ...
        <div class="post-infos">
          <div class="actions">
            {{#if this.args.folder}}
              <DButton
                @icon="arrows-rotate"
                @title="discourse_cs_onedrive.refresh"
              ...
              <DButton
                @icon="folder"
                @title="discourse_cs_onedrive.change_folder"
              ...
              <DButton
                @icon="trash-can"
                @title="discourse_cs_onedrive.remove_folder"
            ...
            <DButton
              ...
              @title="discourse_cs_onedrive.sign_out"
